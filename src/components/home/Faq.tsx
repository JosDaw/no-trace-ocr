'use client'
import { Accordion, Container, Paper, ThemeIcon, Title, rem } from '@mantine/core';
import { IconPlus } from '@tabler/icons-react';

const questions = [
  {
    question: 'How do I create an account?',
    answer: 'To create an account, click on the "Register" button and follow the instructions.',
  },
  {
    question: "How does OCRiginal Translator work?",
    answer: 'After creating an account, you can upload your documents for OCR processing. You can use your free credit or load more credit onto your account to process more documents. Once your documents are processed, you can download the results in your preferred format.',
  },
  {
  ...
  },
  {
    ...
    answer: 'Yes, we use industry-standard encryption to protect your credit card information.'
  },
  {
    question: 'What payment systems to you work with?',
    answer: 'We use PayPal to process payments. You can pay with your PayPal account or with a credit card.'
  },
];
